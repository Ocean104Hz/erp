        ...
        <div className=" items-center gap-2 mb-4">
          <div className="grid grid-cols-3 items-center mb-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button className="bg-sky-400 text-white px-4 py-2 rounded text-sm hover:bg-sky-500 cursor-pointer font-bold">
                Limited Stocks
              </button>
              <button className="bg-blue-800 text-white px-4 py-2 rounded text-sm hover:bg-blue-700 cursor-pointer font-bold">
                Addd new product
              </button>
            </div>
          </div>
