  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-12 mb-4">
        ...
        <Link
            to="/Pages&Media/Voerdor/DownloadApp"
            className="bg-blue-500 px-4 py-2 rounded-full text-white text-"
        >Download App</Link>
      ...
      <p className="bg-yellow-200">
        Please make sure the provided links are correct otherwise buttons are
        redirect to wrong direction.
      </p>
      <div className="bg-white p-6 rounded shadow space-y-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h1 className="text-lg font-semibold mb-6">For android</h1>
          <div>
            ...
            <input
              ...
              onChange={(e) => setTitle(e.target.value)}
              maxLength="50"
              placeholder="EX: https://www.bing.com/store/apps"
              className="w-full border px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
          </div>
        </div>
        <div>
          <h1 className="text-lg font-semibold mb-6">For iOS</h1>
          <div>
            <label className="block text-sm font-medium mb-2">
              Download link
            </label>
            <input
              ...
              onChange={(e) => setTitle(e.target.value)}
              maxLength="50"
              placeholder="EX: https://www.apple.com/ap-store/p"
              className="w-full border px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
          </div>
        </div>
