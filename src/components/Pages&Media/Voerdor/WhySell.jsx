  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-12 mb-4">
        ...
        <Link to="/Pages&Media/Voerdor/WhySell" className="bg-blue-500 px-4 py-2 rounded-full text-white ">Why Sell With Us</Link>
      ...
      <div className="bg-white p-6 rounded shadow space-y-6">
        <div className="mb-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-lg font-semibold">Header section</h1>
              <p>
