    ...
    <div className="w-full p-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white shadow-md rounded-md p-6">
          <h1 className="text-blue-600 ">english(EN)</h1>
          <div className="col-span-2">
            ...
            <select
              ...
              className="w-full p-2 border border-gray-300 rounded-md mt-1"
            >
              <option value="kg">Select product</option>
              <option value="g">Select product1</option>
              <option value="lb">Select product2</option>
              <option value="oz">Select product3</option>
            </select>
          </div>
          </div>
